...
import iconeInstagram from "/src/assets/icons/icons8-instagram-logo-50.png"
import iconeWhatsapp from "/src/assets/icons/icons8-whatsapp-50.png"
import iconeTwitter from "/src/assets/icons/icons8-twitterx-50.png"
    ...
    return(
      ...
      <div className="CaixaVisuPerfil">
          <div className="imagemNome">
            <img src="../src/assets/image/parceira1Brenda.png" alt="perfil" />
            <h2 className="brenda">Brenda Santos, 25</h2> 
            <h3 className="Localizacao">12km • Recife, PE </h3>
            <h4 className="disponivel">Disponível...</h4>

          </div>
          <p className="descricao">Gosto de correr em parques e  também gosto bastante de me 
          exercitar em academias de musculação.</p>
